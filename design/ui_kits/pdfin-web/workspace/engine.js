...
(function () {
  ...
  async function loadFile(file) {
    ...
    const doc = await window.pdfjsLib.getDocument({ data: bytes.slice(), ...PDFJS_OPTS }).promise;
  ...
  window.PdfEngine = { files, loadFile, loadImage, removeFile, reset, renderPage, pageSize, makeSamplePdf, fmtSize };
})();
