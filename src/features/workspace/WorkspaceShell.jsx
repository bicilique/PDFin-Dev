...
import { Button, Card, DownloadCard, IconButton, LangSwitcher, PrivacyPill, ProgressBar } from "../../components/index.js";
...
export const toolIcon = (id, s) => (WSIcons[id] || WSIcons.merge)(s);
      ...
      <div style={{ width: "100%", maxWidth: 560, display: "flex", flexDirection: "column", alignItems: "center", gap: 18, textAlign: "center" }}>
        ...
        <div
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 4 }}>
            <Button variant="primary" onClick={() => inputRef.current && inputRef.current.click()} disabled={busy}>{t.drop.browse}</Button>
        ...
        <PrivacyPill lang={t === PDFIN_T.id ? "id" : "en"} />
      </div>
    </div>
  );
}
