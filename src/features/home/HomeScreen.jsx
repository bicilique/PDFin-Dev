  ...
  const t = lang === "id"
    ? {
        ...
        categoryDesc: {
          ...
          security: "Kelola password, watermark, metadata, tanda tangan visual, dan perataan PDF.",
        },
        ...
        privacyFacts: [
          ...
          "Tanda tangan visual PDF bukan tanda tangan digital berbasis sertifikat.",
    ...
    : {
        ...
        categoryDesc: {
          ...
          security: "Manage passwords, watermarks, metadata, visual signatures, and flattening.",
        },
        ...
        privacyFacts: [
          ...
          "Visual PDF signatures are not certificate-backed digital signatures.",
