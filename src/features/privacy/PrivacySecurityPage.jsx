...
function copy(lang) {
  return lang === "id"
    ? {
        ...
        browserBody: "Untuk alat browser yang mendukung pemrosesan lokal, dokumen diproses langsung di browser Anda dan tidak dikirim ke server pemrosesan PDFin. Browser tetap dapat mengunduh runtime asset yang dibutuhkan untuk menjalankan alat.",
    ...
    : {
        ...
        browserTitle: "Browser Tools",
        browserBody: "For browser tools that support local processing, documents are processed directly in your browser and are not sent to PDFin processing servers. The browser may still download runtime assets required to run the tool.",
        selfHostedTitle: "Self-hosted",
